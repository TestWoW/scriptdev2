...
(-1608000,'Prison guards, we are leaving! These adventurers are taking over! Go, go, go!',0,1,0,'sinclair SAY_BEGIN'),
(-1608001,'I\'m locking the door. Good luck, and thank you for doing this.',0,0,0,'sinclair SAY_LOCK_DOOR'),
(-1608002,'Adventurers, the door is beinning to weaken!',0,1,0,'sinclair SAY_SEAL_75'),
(-1608003,'Only half of the door seal\'s strength remains! You must fight on!',0,1,0,'sinclair SAY_SEAL_50'),
(-1608004,'The door seal is about to collapse! All is lost if the Blue Dragonflight breaks through the door!',0,1,0,'sinclair SAY_SEAL_5'),
(-1608005,'A Portal Guardian defends the new portal!',0,3,0,'EMOTE_GUARDIAN_PORTAL'),
(-1608006,'An elite Blue Dragonflight squad appears from the portal!',0,3,0,'EMOTE_DRAGONFLIGHT_PORTAL'),
(-1608007,'A Guardian Keeper emerges from the portal!',0,3,0,'EMOTE_KEEPER_PORTAL'),
-- common
