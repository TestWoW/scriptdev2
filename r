From 96c56462a91f5c820bec0cf9ea4590a26e53af57 Mon Sep 17 00:00:00 2001
From: fallenangelX <iceis2@hotmail.com>
Date: Mon, 7 Nov 2011 01:58:12 -0500
Subject: [PATCH] [sd2_mr0229] fix Quest 9164

---
 sd2_revision_R2.h                        |    2 +-
 sql_mr/mr00222_mangos_quests_scripts.sql |  657 -----------------------------
 sql_mr/mr00229_mangos_quests_scripts.sql |  676 ++++++++++++++++++++++++++++++
 3 files changed, 677 insertions(+), 658 deletions(-)
 delete mode 100644 sql_mr/mr00222_mangos_quests_scripts.sql
 create mode 100644 sql_mr/mr00229_mangos_quests_scripts.sql

diff --git a/sd2_revision_R2.h b/sd2_revision_R2.h
index 25a7d38..426d988 100644
--- a/sd2_revision_R2.h
+++ b/sd2_revision_R2.h
@@ -1,4 +1,4 @@
 #ifndef __SD2_REVISION_R2_H__
 #define __SD2_REVISION_R2_H__
- #define SD2_REVISION_R2 "0228"
+ #define SD2_REVISION_R2 "0229"
 #endif // __SD2_REVISION_R2_H__
diff --git a/sql_mr/mr00222_mangos_quests_scripts.sql b/sql_mr/mr00222_mangos_quests_scripts.sql
deleted file mode 100644
index a16f862..0000000
--- a/sql_mr/mr00222_mangos_quests_scripts.sql
+++ /dev/null
@@ -1,657 +0,0 @@
--- For YTDB s
...
diff --git a/sql_mr/mr00229_mangos_quests_scripts.sql b/sql_mr/mr00229_mangos_quests_scripts.sql
new file mode 100644
index 0000000..bdb6e3f
--- /dev/null
+++ b/sql_mr/mr00229_mangos_quests_scripts.sql
@@ -0,0 +1,676 @@
+-- For YTDB s
+DELETE FROM scripted_areatrigger WHERE entry=3626;
+INSERT INTO scripted_areatrigger VALUES (3626, 'at_vaelastrasz');
