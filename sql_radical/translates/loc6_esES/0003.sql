...
UPDATE `script_texts` SET `content_loc6` = 'Hoy, habéis demostrado no sólo vuestro valor, sino también que ningún enemigo, ni siquiera el Rey Exánime, puede interponerse cuando la Horda y la Alianza dejan de lado sus diferencias y...' WHERE `entry` = -1610095;
