...
VALUES
	(-1610101, 'Brave champions, we owe you our lives, our freedom... Though it be a tiny gesture in the face of this enormous debt, I pledge that from this day forth, all will know of your deeds, and the blazing path of light you cut through the shadow of this dark citadel.', NULL, NULL, NULL, NULL, NULL, 'Valientes campeones. Os debemos la vida, nuestra libertad... aunque sea un pequeno gesto, ante nuestra gran deuda. Prometo que, de hoy en adelante, todos conocerán vuestras hazanas, y el llameante camino de luz que lográsteis que atravesara esta oscura ciudadela.', NULL, NULL, 17149, 1, 0, 0, 'outro1'),
	(-1610102, 'The forgemaster is dead! Get geared up men, we have a Scourgelord to kill.', NULL, NULL, NULL, NULL, NULL, '¡Héroes! ¡Retendremos a los no-muertos cuanto podamos, hasta nuestro aliento final! ¡Ocupaos del Senor de la Plaga!', NULL, NULL, 17148, 1, 0, 0, 'outro2');
